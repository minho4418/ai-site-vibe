...
export const CATEGORIES: Category[] = [
  {
    ...
    awesomeLists: ["ComposioHQ/awesome-claude-skills"],
  ...
  },
  {
    ...
    awesomeLists: ["e2b-dev/awesome-ai-agents"],
  ...
  },
  {
    ...
    awesomeLists: ["punkpeye/awesome-mcp-servers", "wong2/awesome-mcp-servers"],
